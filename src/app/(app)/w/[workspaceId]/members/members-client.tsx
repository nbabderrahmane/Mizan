...
export function MembersClient({
    ...
    function copyInviteLink(token: string) {
        ...
        toast({ title: "Link copied", description: "Share it with your team member." });
    }
                    ...
                    {isOwner && (
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Invite someone to your workspace by sharing a link or sending an email.
                                </CardDescription>
                            </CardHeader>
            ...
            <Dialog open={showSuccessDialog} onOpenChange={setShowSuccessDialog}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Your invitation is ready! Share this link with the person you want to invite.
                        </DialogDescription>
                    </DialogHeader>
