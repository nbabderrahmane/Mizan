...
export function QuickStart({ workspaceId, stats }: QuickStartProps) {
    ...
    const steps = [
        {
            label: "Add your accounts (bank, cash, savings) in the Accounts section",
            done: stats.hasAccounts,
        },
        {
            label: "Set up categories and subcategories for your expenses",
            done: stats.hasCategories,
        },
        {
            label: "Create your first budget or financial plan",
            done: stats.hasBudgets,
        },
        {
            label: "Start recording your transactions!",
